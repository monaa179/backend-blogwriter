 ...
 */
final class Version20260105152723 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX unique_article_version ON article_version (article_id, version_number)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE article CHANGE suggested_title suggested_title VARCHAR(255) NOT NULL, CHANGE suggested_description suggested_description VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE article_version DROP FOREIGN KEY FK_52CE97747294869C');
        $this->addSql('DROP INDEX unique_article_version ON article_version');
